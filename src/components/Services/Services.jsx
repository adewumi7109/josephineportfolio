...
const serviceData = [
  {
    ...
    content:
      "Designing user-friendly websites and apps that look great and work seamlessly",
  },
  {
    icon: "/icons/branding_watermark.png",
    title: "Branding & Identity",
    content:
      "Crafting unique logos, color palettes, and brand visuals that stand out",
  },
  {
  ...
  },
  {
    ...
    content:
      "Designing flyers, social media graphics, and packaging that make an impact",
  },
  {
    icon: "/icons/edit_note.png",
    title: "Wireframing & Prototyping",
    content:
      "Turning ideas into interactive wireframes and user-friendly flows",
  },
  {
